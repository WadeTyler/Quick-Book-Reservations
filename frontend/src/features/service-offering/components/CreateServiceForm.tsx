...
import {createService} from "@/features/service-offering/lib/service-offering.service";
          ...
          >
            ...
            <fieldset className="input-container">
              ...
              <input type="text"
                     id="name"
                     className="input-bar"
                     placeholder="Enter a Service Offering name"
                     required
                     minLength={3}
                     maxLength={100}
            ...
            <fieldset className="input-container">
              ...
              <input type="text"
                     className="input-bar"
                     id="type"
                     placeholder="Enter a type for your Service Offering: Ex: 'Appointment'"
                     required
                     minLength={3}
                     maxLength={100}
                     onChange={(e) => setFormFields(prev => ({
            ...
            <fieldset className="input-container">
              ...
              <textarea
                ...
                rows={5}
                placeholder="Enter a description for your Service Offering"
                required
                minLength={20}
                maxLength={500}
                onChange={(e) => setFormFields(prev => ({
