...
import ChangeDetails from "@/features/business/components/managed-business/ChangeDetails";
import ChangeImage from "@/features/business/components/managed-business/ChangeImage";
